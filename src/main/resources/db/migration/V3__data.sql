...
SELECT 1, 'Gucci','Tiracolo','Demna Gvasalia','Bolsa tiracolo Dionysus mini',9399,'MÃ©dia',
       ...
       'Exterior: camurÃ§a 100%, canvas 100%',
       '["bege","canvas GG Supreme","recortes de camurÃ§a","placa Dionysus frontal","fechamento por aba dobrÃ¡vel com botÃ£o de pressÃ£o","alÃ§a de ombro removÃ­vel em corrente","compartimento principal","bolso interno com lapela","patch interno de logo","completamente forrado","ferragem prateada","produzido em: ItÃ¡lia","Este item Ã© enviado com uma bolsa protetora."]',
...
INSERT INTO produtos (id, titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, data_criacao, data_atualizacao)
SELECT 2,'Saint Laurent','Transversal','Yves Saint Laurent','Bolsa transversal com logo',10911,'MÃ©dia',
       ...
       'Couro 100%',
       '["Preto","couro","placa de logo","ferragem dourada","matelassÃª chevron","parte superior dobrÃ¡vel","compartimento principal","alÃ§a de ombro de corrente","produzido em: ItÃ¡lia"]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (id, titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, data_criacao, data_atualizacao)
SELECT 3,'Zadig&Voltaire','Ombro','Cecilia BÃ¶nstrÃ¶m','Bolsa de ombro em couro',3239,'MÃ©dia',
       ...
       '["preto","parte superior dobrÃ¡vel","corrente de elos","placa de logo","alÃ§a de ombro ajustÃ¡vel e removÃ­vel","bolso posterior com zÃ­per"]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
SELECT 4,'DeMellier','Tote','Mireia Llusia-Lindh','Bolsa tote The New York efeito pele de crocodilo',5216,'Grande',
       ...
       'Exterior: camurÃ§a 100%',
       '["marrom cedro","ferragem dourada","alÃ§a de mÃ£o dupla arredondada","fecho magnÃ©tico oculto","fechamento lateral por botÃµes de pressÃ£o","compartimento principal","bolso interno com zÃ­per","pÃ© de metal","produzido em: ItÃ¡lia"]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (id, titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, data_criacao, data_atualizacao)
SELECT 5,'The Attico','Tote','Gilda Ambrosio & Giorgia Tordin','Bolsa tote La Passeggiata pequena',13471,'MÃ©dia',
       ...
       'Exterior: couro de bezerro 100% | Forro: camurÃ§a 100%',
       '["preto","fechamento por zÃ­per na parte superior","alÃ§a de mÃ£o dupla arredondada","pÃ© de metal","produzido em: ItÃ¡lia","Este item Ã© enviado com uma bolsa protetora."]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (id, titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, data_criacao, data_atualizacao)
SELECT 6,'Rabanne','Transversal','Paco Rabanne','Necessaire Paco 1969',13345,'MÃ©dia',
...
SELECT 7,'KHAITE','Tote','Catherine Holstein','Bolsa tote Lotus pequena',22838,'Grande',
       ...
       NULL,
       'Exterior: couro de bezerro 100%',
       '["preto","couro","textura granulada","fechamento por alamares","alÃ§a de mÃ£o Ãºnica","estampa de logo na frente","compartimento principal","completamente forrado","produzido em: ItÃ¡lia","Este item Ã© enviado com uma bolsa protetora."]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
SELECT 8,'ZIMMERMANN','Tote','Nicky Zimmermann','Bolsa tote Goldentime',7180,'Grande',
       ...
       'RÃ¡fia 100%',
       '["natural","detalhe de franjas","compartimento interior espaÃ§oso","alÃ§a de mÃ£o","alÃ§a de ombro ajustÃ¡vel","design aberto"]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (id, titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, data_criacao, data_atualizacao)
SELECT 9,'Dolce & Gabbana','Tote','Domenico Dolce & Stefano Gabbana','Bolsa tote Dolce Box com aplicaÃ§Ã£o floral',79250,'Pequena',
       ...
       '["vermelho sangue/multicolorido","couro","aplicaÃ§Ã£o floral","acabamento dourado","ferragem dourada","fechamento por alÃ§a com fecho giratÃ³rio","alÃ§a de ombro ajustÃ¡vel e removÃ­vel","alÃ§a de mÃ£o Ãºnica","compartimento principal","compartimento interno para cartÃ£o","placa de logo interna"]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
SELECT 10,'Prada','Bucket','Miuccia Prada','Bolsa bucket Buckle',38500,'Grande',
       ...
       'Exterior: couro de bezerro 100%',
       '["preto","fechamento por fivelas","ombro Ãºnico","bolso interno","Este item Ã© enviado com uma bolsa protetora."]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (id, titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, data_criacao, data_atualizacao)
SELECT 11,'Dolce & Gabbana','Tote','Domenico Dolce & Stefano Gabbana','Bolsa tote com estampa floral',79250,'MÃ©dia',
       ...
       '["AlÃ§a de mÃ£o Ãºnica","alÃ§a de ombro ajustÃ¡vel e removÃ­vel","fechamento por cadeado","compartimento principal","compartimento interno para cartÃ£o","estampa floral","produzido em: ItÃ¡lia"]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (id, titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, data_criacao, data_atualizacao)
SELECT 12,'Prada','Desfile','Miuccia Prada','Bolsa Galleria mini',45000,'MÃ©dia',
       ...
       '["preto","couro","acabamento envernizado","alÃ§a de ombro ajustÃ¡vel e removÃ­vel","detalhe de acabamento de plumas","porta-chaves","logo triangular","fecho deslizante","bolso interno com zÃ­per"]',
       'bolsas', SYSTIMESTAMP, SYSTIMESTAMP
FROM dual
WHERE NOT EXISTS (
...
SELECT 'MARANT Ã‰TOILE','Saia','Isabel Marant','Saia Berenicia',10966,'pequeno',
    ...
    'Tecido 100%',
       q'[["vermelho escuro","fechamento lateral oculto","detalhe drapeado","bainha assimÃ©trica","estampa de padronagem abstrata"]]',
    'roupas',
       q'[{"altura_cm":179,"busto_cm":84,"cintura_cm":64,"quadril_cm":90,"veste":"38"}]'
FROM dual
WHERE NOT EXISTS (
    SELECT 1 FROM produtos WHERE titulo='MARANT Ã‰TOILE' AND subtitulo='Saia' AND categoria='roupas'
);
...
SELECT 'Maria Lucia Hohan','Vestido','Maria Lucia Hohan','Vestido Noor de seda',20753,'grande',
    ...
    'Seda 100%',
       q'[["vermelho","fechamento posterior por tiras fixadoras","fechamento posterior por zÃ­per","gola V","fenda frontal"]]',
    'roupas',
...
-- MARANT Ã‰TOILE / Colete
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, modelo)
SELECT 'MARANT Ã‰TOILE','Colete','Isabel Marant','Colete Clemencia de pelos com bordado',2757,'pequeno',
    ...
    'Exterior: Seda 100%, camurÃ§a 100%, Poliuretano 100% | Forro: algodÃ£o 100%, PoliÃ©ster 100%',
       q'[["bege taupe","acabamento em pelo","detalhes bordados","modelagem sem mangas","fechamento por botÃ£o","padronagem geomÃ©trica"]]',
    'roupas',
       q'[{"altura_cm":181,"busto_cm":82,"cintura_cm":63,"quadril_cm":89,"veste":"M"}]'
FROM dual
WHERE NOT EXISTS (
    SELECT 1 FROM produtos WHERE titulo='MARANT Ã‰TOILE' AND subtitulo='Colete' AND categoria='roupas'
);

-- Casa Blanca / Vestido (gola polo)
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, modelo)
SELECT 'Casa Blanca','Vestido','Charaf Tajer','Vestido canelado com gola polo',6588,'mÃ©dio',
...
-- Maria Lucia Hohan / Vestido (de festa sem alÃ§as)
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, modelo)
SELECT 'Maria Lucia Hohan','Vestido','Maria Lucia Hohan','Vestido de festa sem alÃ§as',25945,'grande',
    ...
    'Tecido 100%',
       q'[["platina","plissado","decote coraÃ§Ã£o","modelagem sem mangas","fenda lateral","fechamento posterior por amarraÃ§Ã£o","comprimento longo"]]',
    'roupas',
...
-- Missoni / Vestido longo sem mangas com paetÃªs
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, modelo)
SELECT 'Missoni','Vestido','Ottavio & Rosita Missoni','Vestido longo sem mangas com paetÃªs',23271,'grande',
       ...
       NULL,
       'PoliÃ©ster 88%, Elastano 12%',
       q'[["preto","semitranslÃºcido","aplicaÃ§Ã£o de paetÃªs","padronagem de listra","modelagem sem mangas","decote canoa","O item recebido pode diferir levemente da foto. Isso se deve Ã  natureza artesanal com que todos os produtos Missoni sÃ£o confeccionados.","Esta peÃ§a possui detalhes delicados. Manuseie com muito cuidado para evitar danos, como penas quebradas ou perda de paetÃªs."]]',
    'roupas',
...
SELECT 'NISSA','Vestido','NISSA','Vestido longo com design pelerine',10414,'grande',
    ...
    'Forro: Viscose 100% | Exterior: PoliÃ©ster 100%',
       q'[["bege","fechamento posterior por zÃ­per","aplicaÃ§Ãµes de cristais","cÃ³s elÃ¡stico","saia com pregas"]]',
    'roupas',
...
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, modelo)
SELECT 'Karl Lagerfeld','Vestido','Karl Lagerfeld','Vestido polo mangas longas',3274,'mÃ©dio',
    ...
    'PoliÃ©ster 95%, Elastano 5%',
       q'[["preto/branco","tecido com stretch","mangas longas","gola polo","fechamento frontal por botÃµes","acabamento contrastante","punhos largos","detalhe franzido","comprimento midi"]]',
    'roupas',
...
-- Prada / Desfile (Blazer camurÃ§a)
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, modelo)
SELECT 'Prada','Desfile','Miuccia Prada','Blazer de camurÃ§a com abotoamento simples',56000,'grande',
    ...
    'camurÃ§a 100%',
       q'[["rosa","camurÃ§a","patch de logo posterior","lapelas","fechamento frontal por botÃµes","mangas longas","dois bolsos laterais com lapelas","barra reta","completamente forrado"]]',
    'roupas',
       q'[{"altura_cm":175,"busto_cm":83,"cintura_cm":62,"quadril_cm":90,"veste":"ÃšNICO"}]'
FROM dual
WHERE NOT EXISTS (
...
-- Polo / CalÃ§a
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria, modelo)
SELECT 'Polo','CalÃ§a','Ralph Lauren','CalÃ§a reta com vinco',6327,'grande',
    ...
    'Exterior: lÃ£ 100% | Forro: Seda 100%',
       q'[["Preto","efeito amassado","fechamento oculto por botÃ£o","zÃ­per","corte reto","passantes para cinto","dois bolsos laterais internos, dois bolsos posteriores com botÃ£o e debrum","barra reta"]]',
    'roupas',
       q'[{"altura_cm":177,"busto_cm":86,"cintura_cm":64,"quadril_cm":92,"veste":"M"}]'
FROM dual
WHERE NOT EXISTS (
    SELECT 1 FROM produtos WHERE titulo='Polo' AND subtitulo='CalÃ§a' AND categoria='roupas'
);
...
SELECT 'Dolce & Gabbana','Camisa','Domenico Dolce & Stefano Gabbana','Camisa com renda floral',32250,'grande',
    ...
    'Viscose 30%, algodÃ£o 30%, Seda 20%, Poliamida 20%',
       q'[["estampa barroca exclusiva","fecho frontal com botÃµes","punhos no mesmo tecido","caimento fluido"]]',
    'roupas',
...
SELECT 'Dolce & Gabbana','Jaqueta','Domenico Dolce & Stefano Gabbana','Jaqueta cropped de pelos',32250,'pequeno',
    ...
    'Forro: PoliÃ©ster 70%, Nylon 28%, Elastano 2% | Exterior: ModacrÃ­lica 49%, rayon 26%, PoliÃ©ster 25%',
       q'[["Preto","design de pelos","gola redonda","fechamento frontal oculto","mangas longas","comprimento cropped","Produzido em: ItÃ¡lia"]]',
    'roupas',
...
SELECT 'Christian Louboutin','Scarpin','Christian Louboutin','Scarpin Kate 120',8969,'Pequeno',
    ...
    'Forro: couro 100% | Exterior: camurÃ§a 100% | Solado: couro 100%',
       q'[["bico fino","signature Louboutin red lacquered sole","salto agulha alto 120mm","produzido em: ItÃ¡lia"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
SELECT 'Balenciaga','Scarpin','Pierpaolo Piccioli','Scarpin Monday de couro com salto 140mm',10788,'Pequeno',
    ...
    'Exterior: couro de bezerro 100%, Tecido 100% | Forro: Tecido 100% | Solado: borracha 100%',
       q'[["salto 140mm","preto","couro","fechamento por amarraÃ§Ã£o","solado esculpido","detalhe de logo"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
SELECT 'GCDS','Scarpin','Giuliano Calza','Scarpin Morso Mirror com salto 110mm',7290,'Pequeno',
       ...
       q'[["prateado","bico fino","solado de couro","salto Morso","produzido em: ItÃ¡lia"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
SELECT 'Christian Louboutin','Scarpin','Christian Louboutin','Scarpin com tassel e salto 110mm',12597,'Pequeno',
    ...
    'Solado: couro de bezerro 100% | Forro: couro de bezerro 100% | Exterior: Tecido 100%',
       q'[["vermelho bordÃ´","veludo","detalhe de tassel","logo na palmilha","bico fino","salto agulha alto","modelagem slip-on"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
SELECT 'Versace','Bota','Donatella Versace','Bota de couro com salto alto',13385,'Grande',
    ...
    'Exterior: couro 100% | Forro: couro 100% | Solado: couro 100%',
       q'[["Preto","bico quadrado","fechamento por zÃ­per lateral","cano alto","plataforma e salto alto bloco","couro"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria)
SELECT 'Le Silla','Ankle Boot','Enio Silla','Ankle boot Eva de couro',8159,'MÃ©dio',
    ...
    'Exterior: Pele de cordeiro 100% | Forro: couro nappa 100% | Solado: couro de bezerro 100%',
       q'[["vermelho escuro","couro","textura leve","comprimento longo","fechamento por zÃ­per lateral","bico fino","salto agulha alto"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria)
SELECT 'Giuseppe Zanotti','Bota','Giuseppe Zanotti','Bota Brytta High com salto 90mm',4498,'MÃ©dio',
    ...
    'Outras fibras 100%',
       q'[["preto","couro","acabamento envernizado","bico fino","fechamento por zÃ­per lateral oculto","salto agulha alto 90mm","produzido em: ItÃ¡lia"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
-- Dolce & Gabbana / TÃªnis Airmaster
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria)
SELECT 'Dolce & Gabbana','TÃªnis','Domenico Dolce & Stefano Gabbana','TÃªnis Airmaster com recortes',5400,'MÃ©dio',
    ...
    'Couro 100%',
       q'[["branco","couro","fechamento frontal por amarraÃ§Ã£o","patch de logo na lingueta","solado flat de borracha","recorte matelassÃª no calcanhar","produzido em: ItÃ¡lia"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
    SELECT 1 FROM produtos WHERE titulo='Dolce & Gabbana' AND subtitulo='TÃªnis' AND categoria='sapatos'
);
...
SELECT 'Dolce & Gabbana','Bota','Domenico Dolce & Stefano Gabbana','Bota KIM DOLCE&GABBANA de cetim com strass',39000,'Grande',
    ...
    'Seda 100%',
       q'[["aplicaÃ§Ã£o de cristais","produzido em: ItÃ¡lia"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
SELECT 'Gucci','Mule','Gucci','Mule Interlocking G com salto 70mm',13590,'Pequeno',
    ...
    'Solado: couro de bezerro 100%, borracha 100% | Forro: couro de bezerro 100% | Exterior: couro de bezerro 100%, metal 100%',
       q'[["preto","couro","modelo slip-on","salto mÃ©dio esculpido 70mm","salto Interlocking G prateado","abertura frontal","palmilha com logo","produzido em: ItÃ¡lia"]]',
    'sapatos'
FROM dual
WHERE NOT EXISTS (
...
INSERT INTO produtos (titulo, subtitulo, autor, descricao, preco, dimensao, imagem, imagem_hover, imagens, composicao, destaques, categoria)
SELECT 'Prada','Mocassim','Miuccia Prada','Mocassim Chocolate de couro',8200,'MÃ©dio',
