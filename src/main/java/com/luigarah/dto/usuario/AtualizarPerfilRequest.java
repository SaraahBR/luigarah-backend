...
public class AtualizarPerfilRequest {
    ...
    @Schema(description = "Nome do usuário", example = "Sarah", maxLength = 100)
    private String nome;

    @Schema(description = "Sobrenome do usuário", example = "Hernandes", maxLength = 100)
    private String sobrenome;

    @Schema(
        description = "Telefone do usuário (aceita com ou sem formatação)",
        example = "(43) 99161-6465"
    )
    @Pattern(
    ...
    @Schema(description = "Data de nascimento no formato ISO 8601", example = "2002-04-13")
